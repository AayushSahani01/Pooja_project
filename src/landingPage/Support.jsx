         ...
         <div className='  text-center p-4 m-48'>
            <div className='bg-amber-200'>
                ...
                <div className='text-2xl font-light p-6 m-4  '>
                    <p>We here at Pooja Designer Boutique believe that a perfect fit is as important as a perfect design. Therefore, we provide expert tailoring to ensure that any garment, be it ready-made or custom, fits you to perfection. Our zone of experts with years of tailoring experience bring forth garments that not only flatter your natural silhouette but also mirror your persona.</p>
                </div>
