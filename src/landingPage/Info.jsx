        ...
        <div className='  p-4 mt-4 grid-cols-2 '>
            <div className='  flex flex-row'>
                ...
                <div className='grid grid-cols-2 px-96 gap-4 ' >
                    ...
                    <input type="text" placeholder="Your name" className='border border-b-gray-700 rounded-lg p-2 w-fit '/>
                      <label htmlFor="">Email:(required)</label>
                    <input type="text"  placeholder="Enter E-mail" className='border border-b-gray-700 rounded-lg p-2 w-fit' />
                      <label htmlFor="">Message:</label>
                    <input type="text" placeholder='Type your message here...' 
                     className='border border-b-gray-700 p-4 rounded-lg w-fit'/>
                    <button type="button" className=' border border-stone-500 rounded-full text-2xl bg-gray-800 flex justify-self-center text-white p-2 m-6 '>Submit</button>
                </div>
